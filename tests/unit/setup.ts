...
// Read before the scrub. DATABASE_URL because several files (streamer-jobs,
// audit, api/v1/token-lifecycle) write to and deleteMany() from the real
// Prisma client — hard-coding it aims those writes at whatever the default names.
