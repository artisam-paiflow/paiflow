...
| Swapper panel, builder and palette **before** D1, from paiflow.xyz (9 Sep)                            | 3 screenshots                   | `d3/00`–`02` — captured as the D3 "before" while the public app still ran pre-D1 code; since reclassified as the pre-sprint baseline, D1's "before" ([D3 evidence pack](evidence/d3/README.md))                                                                                                                                                                                                    |
