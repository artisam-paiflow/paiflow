...
| 17 Sep | The external QA run's developer API test ([D2 test cases](https://docs.google.com/document/d/1vZRCa0VmGrBiNaJN_FISnbbSNwEscLj1fO0HyyOr4v4/edit), TC-015 is `cbe539ff…`): two 0.1 XLM swaps through `/api/v1` on one deployment | D2          | [`8d8e1d6b…`](https://stellar.expert/explorer/testnet/tx/8d8e1d6b96c615b4ed6f6e8ce40218e07b8b0a38b5694b0fbf31675c7995e2f6)<br>[`cbe539ff…`](https://stellar.expert/explorer/testnet/tx/cbe539ffdfa204ec6b1463bfd1741f9cb2be1caa10e196096e52726faf97a577) |
...
The 17 September pair come from the external QA run, not from the team. QA ran the
[Paiflow Deliverable 2 Test Cases](https://docs.google.com/document/d/1vZRCa0VmGrBiNaJN_FISnbbSNwEscLj1fO0HyyOr4v4/edit) against beta.app.paiflow.xyz on 17–18 September (see
[D2](../deliverables/d2.md#found-in-the-close-out-audit)). [`cbe539ff…`](https://stellar.expert/explorer/testnet/tx/cbe539ffdfa204ec6b1463bfd1741f9cb2be1caa10e196096e52726faf97a577)
is its TC-015 transaction, and [`8d8e1d6b…`](https://stellar.expert/explorer/testnet/tx/8d8e1d6b96c615b4ed6f6e8ce40218e07b8b0a38b5694b0fbf31675c7995e2f6)
followed it ten seconds later. Both were signed by QA's `GC3U7BCX…` and deposit 1,000,000 stroops
(0.1 XLM) into deployment `e27ca499`, and each swapped to 0.0105843 USDC. They appear in
[`swapper-flows-live-2026-09-18.json`](swapper-flows-live-2026-09-18.json) and are listed here so the
record of what ran on the public app is complete. They are test traffic rather than alpha-round
activity, and are counted on neither reporting basis.

QA's two documents are kept by QA and linked rather than copied: the
[D2 test cases](https://docs.google.com/document/d/1vZRCa0VmGrBiNaJN_FISnbbSNwEscLj1fO0HyyOr4v4/edit) and the [QA / UX findings](https://docs.google.com/document/d/1U8iZViPNstKnLC32Jacv2v63o0EX-0EKySW8gvuvTTo/edit), whose fixed defects are credited in
[week 2](../week-2.md#issues-found-and-fixed).
