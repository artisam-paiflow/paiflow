...
| 10  | `docs/archive/dev-mode-mutable-flows.md` records a prior decision: "**Do NOT rewrite the swapper.**"                                                                                                                                                                                                                                                          | It is archived, so presumably superseded — but it is the only written rationale for the current design, and D1 reverses it. Confirm that is intentional.                     |
